...
const Nav = () => (
  <div>
    ...
    <IndexLink activeClassName='active' to='/acordes'>Acordes</IndexLink>&nbsp;
    <IndexLink activeClassName='active' to='/about'>About</IndexLink>&nbsp;
    <IndexLink activeClassName='active' to='/namedComponent'>Named Components</IndexLink>&nbsp;
    <IndexLink activeClassName='active' to={{ pathname: '/acorde/query', query: { message: 'Hello from Route Query' } }}>Route Query</IndexLink>
  </div>
)
...
const Acordes = (props) => <div>
  <br />
  <Link to='/acordes'>La</Link>&nbsp;
  <Link to='/acordes/laSib'>La#Sib</Link>
  {props.children}
</div>

const LaSib= () => <h3>la#Sib</h3>
const La = () => <h3>La</h3>
